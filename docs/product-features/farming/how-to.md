...
5. Wait for transaction confirmation. It may take up to 20–40 minutes for changes to be visible on the network and in your wallet. Remember, you can turn on [Telegram notifications](https://t.me/stacks\_tx\_notification\_bot) or search for the transaction on the [ALEX Explorer](https://app.alexlab.co/explorer).
