...
Yield Farming on ALEX is an excellent way to earn exciting returns. By farming (staking or locking up your LP tokens), you earn both $ALEX and APower rewards in addition to the earnings from being a liquidity provider.

To farm, you first deposit two tokens into a liquidity pool, receiving LP tokens in return. You then stake these LP tokens in a farm to start earning rewards. This allows you to accumulate $ALEX and APower while still benefiting from the trading fees generated by the pool.
