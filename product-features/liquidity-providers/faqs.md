...
When a user adds liquidity to a pool, they receive LP tokens as proof of ownership, entitling them to a proportional share of the pooled assets and any fees generated by trades (swaps) in that pool.
